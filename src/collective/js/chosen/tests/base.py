...
from collective.js.chosen.testing import (
    COLLECTIVE_JS_CHOSEN_FIXTURE as UNIT_TESTING,
    COLLECTIVE_JS_CHOSEN_INTEGRATION_TESTING as INTEGRATION_TESTING,
    COLLECTIVE_JS_CHOSEN_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING,
    COLLECTIVE_JS_CHOSEN_SELENIUM_TESTING as SELENIUM_TESTING,
)

...
class CollectiveJsChosenLayer(PloneSandboxLayer):
    ...
    def setUpPloneSite(self, portal):
        self.portal = portal
        applyProfile(portal, 'collective.js.chosen:default')


class LayerMixin(object):
    defaultBases = (CollectiveJsChosenLayer() ,)
...
COLLECTIVE_JS_CHOSEN_FIXTURE             = CollectiveJsChosenLayer()
COLLECTIVE_JS_CHOSEN_INTEGRATION_TESTING = IntegrationTesting(name = "CollectiveJsChosen:Integration")
COLLECTIVE_JS_CHOSEN_FUNCTIONAL_TESTING  = FunctionalTesting( name = "CollectiveJsChosen:Functional")
COLLECTIVE_JS_CHOSEN_SELENIUM_TESTING    = FunctionalTesting(bases = (SELENIUM_TESTING, COLLECTIVE_JS_CHOSEN_FUNCTIONAL_TESTING,), name = "CollectiveJsChosen:Selenium")
